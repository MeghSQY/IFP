...
/**IFP settings to modify any QOL features. This is the editor settings,
 * but is project wide, as these settings should be enforced for everyone. */
UCLASS(DisplayName = "Inventory Framework (Editor)", DefaultConfig, Config = Editor)
...
public:
	...
	virtual FText GetSectionText() const override { return INVTEXT("Inventory Framework (Editor)"); }
};
