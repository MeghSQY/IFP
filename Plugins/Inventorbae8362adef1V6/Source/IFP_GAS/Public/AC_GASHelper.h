...
class IFP_GAS_API UAC_GASHelper : public UActorComponent, public II_InventoryExtension
{
	GENERATED_BODY()
...
public:
	...
	/**Called once StartComponent is called*/
	virtual void PreInventoryComponentInitialized_Implementation(UAC_Inventory* InventoryComponent) override;
	virtual void PostInventoryComponentInitialized_Implementation(UAC_Inventory* InventoryComponent) override;
	...
	UFUNCTION(Category = "GAS Helper", BlueprintCallable, meta = (DeprecatedFunction, DeprecationMessage = "You no longer need to call this. This is handled automatically"))
