...
void UAC_GASHelper::PreInventoryComponentInitialized_Implementation(UAC_Inventory* InventoryComponent)
{
	II_InventoryExtension::PreInventoryComponentInitialized_Implementation(InventoryComponent);
...
void UAC_GASHelper::PostInventoryComponentInitialized_Implementation(UAC_Inventory* InventoryComponent)
{
	II_InventoryExtension::PostInventoryComponentInitialized_Implementation(InventoryComponent);
...
{
	//This function is deprecated. Logic has been moved to PostInventoryComponentInitialized
}
