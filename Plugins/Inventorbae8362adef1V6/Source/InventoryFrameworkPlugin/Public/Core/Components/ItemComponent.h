 ...
 *
 * Docs:
 * https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/classes-and-settings/traits-and-components */
...
public:
	...
	TObjectPtr<UIT_ItemComponentTrait> DataObject = nullptr;
