...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_SevenParams(FItemMoved, FS_InventoryItem, OriginalItemData, FS_InventoryItem, NewItemData, FS_ContainerSettings, FromContainer, FS_ContainerSettings, ToContainer,
	UAC_Inventory*, FromComponent, UAC_Inventory*, ToComponent, const TArray<FS_ContainerSettings>&, OriginalItemsContainersMoved);
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FContainerAdded, FS_ContainerSettings, Container);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FContainerRemoved, FS_ContainerSettings, Container);
 ...
 *
 * Docs: https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/classes-and-settings/ac_inventory */
...
public:
	...
	TArray<TObjectPtr<UAC_Inventory>> Listeners;
	...
	TObjectPtr<UAC_Inventory> InteractingWith = nullptr;
	...
	TMap<FName, TObjectPtr<UTextureRenderTarget2D>> GeneratedItemIcons;

	/**The active drag widget when dragging an item*/
	UPROPERTY(BlueprintReadWrite, Category = "UI")
	TObjectPtr<UW_Drag> DragWidget = nullptr;
	 ...
	 *
	 * Docs:
	 * https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/working-in-the-system/drag-and-drop */
	...
	TObjectPtr<UInputMappingContext> UINavigationContext = Cast<UInputMappingContext>(StaticLoadObject(UObject::StaticClass(), nullptr, TEXT("/InventoryFrameworkPlugin/Core/EnhancedInput/MappingContexts/IMC_UI_Navigation_IFP.IMC_UI_Navigation_IFP")));
	
	/**Key that must be pressed to rotate an item while it is being dragged.*/
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Settings|UI")
	TObjectPtr<UInputAction> RotateKey = Cast<UInputAction>(StaticLoadObject(UObject::StaticClass(), nullptr, TEXT("/InventoryFrameworkPlugin/Core/EnhancedInput/InputActions/IA_UI_RotateKey.IA_UI_RotateKey")));
	
	/**Key that must be held down to perform a split operation on a stacked item*/
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Settings|UI")
	TObjectPtr<UInputAction> SplitKey = Cast<UInputAction>(StaticLoadObject(UObject::StaticClass(), nullptr, TEXT("/InventoryFrameworkPlugin/Core/EnhancedInput/InputActions/IA_UI_SplitKey.IA_UI_SplitKey")));
	
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Settings|UI")
	TObjectPtr<UInputAction> SelectItem = Cast<UInputAction>(StaticLoadObject(UObject::StaticClass(), nullptr, TEXT("/InventoryFrameworkPlugin/Core/EnhancedInput/InputActions/IA_UI_SelectItem.IA_UI_SelectItem")));
	
	/**Key to navigate up in a container widget.*/
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Settings|UI")
	TObjectPtr<UInputAction> NavigateUp = Cast<UInputAction>(StaticLoadObject(UObject::StaticClass(), nullptr, TEXT("/InventoryFrameworkPlugin/Core/EnhancedInput/InputActions/IA_UI_NavigateUp.IA_UI_NavigateUp")));
	
	/**Key to navigate right in a container widget.*/
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Settings|UI")
	TObjectPtr<UInputAction> NavigateRight = Cast<UInputAction>(StaticLoadObject(UObject::StaticClass(), nullptr, TEXT("/InventoryFrameworkPlugin/Core/EnhancedInput/InputActions/IA_UI_NavigateRight.IA_UI_NavigateRight")));
	
	/**Key to navigate down in a container widget.*/
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Settings|UI")
	TObjectPtr<UInputAction> NavigateDown = Cast<UInputAction>(StaticLoadObject(UObject::StaticClass(), nullptr, TEXT("/InventoryFrameworkPlugin/Core/EnhancedInput/InputActions/IA_UI_NavigateDown.IA_UI_NavigateDown")));
	
	/**Key to navigate left in a container widget.*/
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Settings|UI")
	TObjectPtr<UInputAction> NavigateLeft = Cast<UInputAction>(StaticLoadObject(UObject::StaticClass(), nullptr, TEXT("/InventoryFrameworkPlugin/Core/EnhancedInput/InputActions/IA_UI_NavigateLeft.IA_UI_NavigateLeft")));
...
public:
	...
	/**A container has been manually added to the component through
	 * the @AddContainer function. */
	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "EventDispatchers")
	FContainerAdded ContainerAdded;

	/**A container has been manually removed from the component through
	 * the @RemoveContainer function.
	 * The returned container settings aren't valid, since this is post removal. */
	UPROPERTY(BlueprintAssignable, BlueprintCallable, Category = "EventDispatchers")
	FContainerRemoved ContainerRemoved;
...
#pragma region Management
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Management")
	...
	UFUNCTION(Client, Reliable, BlueprintCallable, Category = "Inventory Component|Management")
	void C_RequestServerContainerData(bool CallServerDataReceived);

	UFUNCTION(Server, Reliable, Category = "Inventory Component|Management")
	void S_SendContainerDataToClient(bool CallServerDataReceived);

	UFUNCTION(Client, Reliable, Category = "Inventory Component|Management")
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Inventory Component|Management")
	void StopComponent();
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Management", meta = (DisplayName = "Reset All Unique ID's"))
	void ResetAllUniqueIDs();

	/**Returns the components current state.
	 * Docs: varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/classes-and-settings/ac_inventory#states */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Inventory Component|Management")
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Management", CallInEditor, meta = (DevelopmentOnly))
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Management", DisplayName = "Refresh ID Map")
	void RefreshIDMap();
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Management", DisplayName = "Add UniqueID to ID Map")
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Management", DisplayName = "Remove UniqueID from ID Map")
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Management", DisplayName = "Validate ID Map")
...
#pragma region Items
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Items")
	...
	void C_MoveItem(FS_InventoryItem ItemToMove, UAC_Inventory* FromComponent, UAC_Inventory* ToComponent, int32 ToContainer, int32 ToIndex,int32 Count,
		bool CallItemMoved, bool CallItemAdded, bool SkipCollisionCheck, ERotation NewRotation, const TArray<FS_UniqueID> &ItemContainers, FRandomStream Seed);
	...
	UFUNCTION(BlueprintNativeEvent, Category = "Inventory Component|Items", DisplayName = "Remove Item From Inventory (Non-replicated)")
	...
	void LoadAndDropItem(FS_InventoryItem Item);

	UFUNCTION(BlueprintImplementableEvent, Category = "Inventory Component|Items", DisplayName = "DropItem")
	void Internal_DropItem(FS_InventoryItem Item);

	UFUNCTION(BlueprintNativeEvent, BlueprintCallable, BlueprintPure, Category = "Inventory Component|Items")
	 ...
	 *
	 * Docs: https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/working-in-the-system/adding-new-items-during-runtime
	 * 
	...
	UFUNCTION(BlueprintCallable, BlueprintAuthorityOnly, Category = "Inventory Component|Items")
...
#pragma region ItemsTags
	 ...
	 *
	 * Docs: https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/systems/tags-and-tag-values*/
...
#pragma region Getters
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Getters")
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Getters")
	TArray<FS_ContainerSettings> GetContainersByIdentifiers(FGameplayTagContainer ContainerIdentifiers, TArray<FS_ContainerSettings> ContainerList, bool AllowItemsContainers);
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Getters", meta = (DisplayName = "Get Item By UniqueID In Container"))
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Getters", meta = (ReturnDisplayName = "Item"))
	...
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Inventory Component|Getters")
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Getters", meta = (ReturnDisplayName = "Containers"))
	TArray<FS_ContainerSettings> GetItemsChildrenContainers(FS_InventoryItem Item, UPARAM(DisplayName = "Required Identifiers (Optional)") FGameplayTagContainer RequiredIdentifiers = FGameplayTagContainer());
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Getters", meta = (ReturnDisplayName = "ParentItem"))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Inventory Component|Getters")
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, BlueprintNativeEvent, Category = "Inventory Component|Getters")
	...
	/**Gets the equipped item in the specified container.
	 * @ContainerOwningItem The item that owns the container.
	 * If left empty, we only check containers that belong to this component.
	 * This can also be used to check if an item is equipped in this container
	 * by checking if the item is valid. */
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Inventory Component|Getters")
	FS_InventoryItem GetEquippedItemInContainer(FGameplayTag ContainerIdentifier, UPARAM(DisplayName = "Container Owning Item (Optional)") FS_InventoryItem ContainerOwningItem);

	/**Returns a list of containers that have identifiers that match @Identifiers.
	 * Optionally, this can be filtered down to containers that belong to a specific
	 * item, and/or containers that are compatible with a specific container.*/
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Inventory Component|Getters")
	TArray<FS_InventoryItem> GetItemsFromContainers(FGameplayTagContainer Identifiers,
		UPARAM(DisplayName="Belongs To Item(Optional)") FS_InventoryItem BelongsToItem,
		UPARAM(DisplayName="Must Be Compatible With (Optional)") FS_ContainerSettings MustBeCompatibleWith);
...
#pragma region Tiles
	...
	UFUNCTION(BlueprintImplementableEvent, BlueprintCallable, Category = "Inventory Component|Tiles|Visuals")
...
#pragma region Containers
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Containers")
	...
	UFUNCTION(Server, Reliable, Category = "Inventory Component|Containers")
	void S_AdjustContainerSize(FS_ContainerSettings Container, FMargin Adjustments, bool ClampToItems, ENetRole CallerLocalRole);
	
	UFUNCTION(Client, Reliable, Category = "Inventory Component|Containers")
	void C_AdjustContainerSize(FS_UniqueID ContainerID, FMargin Adjustments, bool ClampToItems, FRandomStream Seed);

	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Containers", meta = (DisplayName = "Adjust Container Size (Non-replicated)"))
	...
	/**Adds a container, which can optionally be owned by an item.
	 * The UniqueID returned by this function is what will be assigned
	 * to the container. So for multiplayer, you can bind to the
	 * @ContainerAdded delegate and compare the returned Container's
	 * UniqueID to see if it is the one you just tried to add here, but
	 * this output will only work if the client has authority.
	 *
	 * This will NOT accept items in the containers Items array.
	 * The items array will be emptied. You should be adding a container,
	 * then adding items to it.
	 *
	 * If your game is competitive, I highly recommend limiting this
	 * function to only be allowed to work on the clients own component. */
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Containers")
	FS_UniqueID AddContainer(UAC_Inventory* TargetComponent, FS_ContainerSettings NewContainer, UPARAM(DisplayName = "Owning Item (Optional)") FS_InventoryItem OwningItem = FS_InventoryItem());
	/**Helper function for @AddContainer*/
	int32 GetIndexForNewRuntimeContainer(FS_InventoryItem OwningItem);
	bool VerifyContainerToAdd(FS_ContainerSettings Container, FS_InventoryItem OwningItem);

	UFUNCTION(Server, Reliable)
	void S_AddContainer(UAC_Inventory* TargetComponent, FS_ContainerSettings NewContainer, FS_UniqueID OwningItem, ENetRole CallerLocalRole);
 
	UFUNCTION(Client, Reliable)
	void C_AddContainer(UAC_Inventory* TargetComponent, FS_ContainerSettings NewContainer, FS_UniqueID OwningItem);
 
	void Internal_AddContainer(UAC_Inventory* TargetComponent, FS_ContainerSettings NewContainer, FS_InventoryItem OwningItem);

	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Containers")
	void RemoveContainer(FS_ContainerSettings Container);

	UFUNCTION(Server, Reliable)
	void S_RemoveContainer(FS_UniqueID ContainerID, ENetRole CallerLocalRole);

	UFUNCTION(Client, Reliable)
	void C_RemoveContainer(FS_UniqueID ContainerID);

	void Internal_RemoveContainer(FS_ContainerSettings Container);
	...
	/**Add a tag to an item. Returns true or false depending if the addition was successful.
	 * This is predictive, if ran on the client, the return might not work.*/
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Containers|Tags")
	 ...
	 * If multiplayer, this is only asked on the server.*/
	UFUNCTION(BlueprintCallable, BlueprintNativeEvent, Category = "Inventory Component|Containers|Tags")
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Containers|Helpers")
...
#pragma region Component
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Inventory Component|Initializers", meta = (CompactNodeTitle = "GenerateID"))
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Inventory Component|Initializers", meta = (CompactNodeTitle = "GenerateID (Seed)", DisplayName = "Gnerate UniqueID With Seed"))
	FS_UniqueID GenerateUniqueIDWithSeed(FRandomStream Seed);

	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Inventory Component|Initializers", meta = (DisplayName = "Is UniqueID In Use"))
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Component|Tags")
	...
	UFUNCTION(Category = "Inventory Component|Tags", BlueprintCallable)
...
#pragma region NetworkManagement
	...
	UFUNCTION(Server, Reliable, BlueprintCallable, Category = "Inventory Component|Networking||Management")
	void S_AddListener(UAC_Inventory* Component);

	/**Remove self as a listener for this component. The @Target should always be a component that
	 * the player has authority over, such as the local inventory component.
	 * This component will no longer receive RPC updates whenever a container
	 * or item is modified inside @OtherComponent.
	...
	UFUNCTION(BlueprintCallable, Category = "Inventory Component|Networking||Management")
	void RemoveSelfAsListener(UAC_Inventory* OtherComponent);

	UFUNCTION(Server, Reliable)
	void S_RemoveSelfAsListener(UAC_Inventory* OtherComponent);
	
	UFUNCTION(Client, Reliable)
	void C_SetClientReceivedContainerData(UAC_Inventory* OtherComponent, bool HasReceived);
	...
	UFUNCTION(Client, Unreliable, BlueprintCallable, Category = "Inventory Component|Networking||Client")
	...
	UFUNCTION(BlueprintCallable, Client, Reliable, Category = "Inventory Component|Networking||Client")
...
#pragma region Editor
	...
	UFUNCTION()
	TArray<TSoftObjectPtr<UScriptStruct>> GetDisallowedItemFragments() const;
