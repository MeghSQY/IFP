...
struct FS_UniqueID
{
	...
	TObjectPtr<UAC_Inventory> ParentComponent = nullptr;
...
USTRUCT(BlueprintType)
struct INVENTORYFRAMEWORKPLUGIN_API FCoreFragment
{
	GENERATED_BODY()
	 ...
	 * This is used when StartComponent is called on the inventory component.
	 *
	 * For example, the tag fragment can have certain tags and values inside the
	 * item asset. But sometimes you want to override just one value for an item.
	 * The tag fragment overrides this and handles that scenario, allowing the
	 * struct from the item asset to be merged with the one found on the item struct.
	 * 
	 * NOTE: This is causing issues for Mac users. For some reason, this keeps encountering
	 ...
	 * Some users have pointed out that the .generated.h file is not being generated
	 * correctly and can be modified to remove this double instantiation.
	 * While this bug exists, IFP does not officially support Mac */
	...
	/**Return true if you do not want this fragment in the dropdown menu.*/
	virtual bool DoNotShowInDropdown() { return false; }
...
USTRUCT(BlueprintType)
struct INVENTORYFRAMEWORKPLUGIN_API FItemFragment : public FCoreFragment
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct INVENTORYFRAMEWORKPLUGIN_API FContainerFragment : public FCoreFragment
{
	GENERATED_BODY()
...
struct FS_InventoryItem
{
	...
	TObjectPtr<UDA_CoreItem> ItemAsset = nullptr;
	 ...
	 * set to @Client.*/
	UPROPERTY(BlueprintReadWrite, Category = "Item")
	TArray<TObjectPtr<UItemComponent>> ItemComponents;
	...
	TObjectPtr<UW_InventoryItem> Widget = nullptr;
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Item", NoClear,
		meta = (PinHiddenByDefault, ShowTreeView, ExcludeBaseStruct, DisallowedClasses = "/Script/InventoryFrameworkPlugin.ContainerFragment", GetDisallowedClasses = "GetDisallowedItemFragments"))
...
struct FS_CompatibilitySettings
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Compatibility")
	TArray<TObjectPtr<UDA_CoreItem>> ItemWhitelist;

	//These items are not allowed
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Compatibility")
	TArray<TObjectPtr<UDA_CoreItem>> ItemBlacklist;
...
struct FS_ContainerSettings
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, NoClear,
		meta = (ExcludeBaseStruct, ShowTreeView, ExcludeBaseStruct, DisallowedClasses = "/Script/InventoryFrameworkPlugin.ItemFragment"), Category = "Container")
	...
	UPROPERTY(BlueprintReadWrite, NotReplicated, Category = "Container", meta = (PinHiddenByDefault))
	TObjectPtr<UW_Container> Widget = nullptr;
