...
#pragma region Items
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "IFP|Items|Checkers")
	static bool IsRotationAllowed(TEnumAsByte<ERotation> Rotation);
	...
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "IFP|Items|Getters")
	static TEnumAsByte<ERotation> GetNextRotation(TEnumAsByte<ERotation> Rotation);
...
#pragma region Other
	...
	UFUNCTION(Category = "IFP|Other", BlueprintCallable, BlueprintPure)
	static TArray<UActorComponent*> GetComponentsWithInterface(AActor* Actor, TSubclassOf<UInterface> Interface);
