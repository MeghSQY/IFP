...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Drag", meta = (ExposeOnSpawn = true))
	TObjectPtr<UW_InventoryItem> ItemWidget = nullptr;
	...
	TObjectPtr<UW_Tile> ClampedTile = nullptr;

	UPROPERTY(BlueprintReadWrite, Category = "Container and Tiles")
	TObjectPtr<UW_Container> Container = nullptr;
	...
	TObjectPtr<class UImage> Highlight = nullptr;
