 ...
 * Docs: https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/classes-and-settings/w_tile */
UCLASS(Abstract)
...
public:
	...
	TObjectPtr<UW_Container> ParentContainer = nullptr;
	...
	TObjectPtr<USlateBrushAsset> HighlightBrush = nullptr;
