...
public:
	...
	UPROPERTY(BlueprintReadWrite, Category="Drag&Drop")
	TObjectPtr<UDragDropOperation> DragDropOperation = nullptr;
	
	UPROPERTY(BlueprintReadWrite, Category = "Settings")
	TObjectPtr<UW_Tile> CurrentHoverTile = nullptr;

	//Used to tell highlight where to interp it's location from.
	UPROPERTY(BlueprintReadWrite, Category = "Settings")
	TObjectPtr<UW_Tile> OldHoverTile = nullptr;
	...
	UPROPERTY(BlueprintReadWrite, Category = "Settings")
	TObjectPtr<UAC_Inventory> TargetComponent = nullptr;
