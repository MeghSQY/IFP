 ...
 *
 * Docs: https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/classes-and-settings/w_inventoryitem
 */
UCLASS(Abstract)
...
public:
	...
	TArray<TObjectPtr<UW_Tile>> ParentTiles;

	UPROPERTY(BlueprintReadWrite, Category = "Container")
	TObjectPtr<UW_Container> ParentContainer;
