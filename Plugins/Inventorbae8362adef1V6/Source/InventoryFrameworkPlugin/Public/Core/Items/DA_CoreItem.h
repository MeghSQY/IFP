 ...
 *
 * Docs: https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/classes-and-settings/da_coreitem */
...
public:
	 ...
	 * Docs: https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/classes-and-settings/traits-and-components */
	UPROPERTY(EditDefaultsOnly, Instanced, BlueprintReadWrite, Category = "Core Settings")
	TArray<TObjectPtr<UItemTrait>> TraitsAndComponents;
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Core Settings", NoClear,
		meta = (PinHiddenByDefault, ShowTreeView, ExcludeBaseStruct, DisallowedClasses = "/Script/InventoryFrameworkPlugin.ContainerFragment", GetDisallowedClasses = "GetDisallowedItemStructFragments"))
	...
	UPROPERTY(BlueprintReadWrite, EditAnywhere, Category = "Core Settings", NoClear,
		meta = (PinHiddenByDefault, ShowTreeView, ExcludeBaseStruct, DisallowedClasses = "/Script/InventoryFrameworkPlugin.ContainerFragment", GetDisallowedClasses = "GetDisallowedItemAssetFragments"))
	 ...
	 * Docs: https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/introduction/first-steps/asset-manager#adding-custom-asset-types */
	...
	UFUNCTION()
	TArray<TSoftObjectPtr<UScriptStruct>> GetDisallowedItemStructFragments() const;

	UFUNCTION()
	TArray<TSoftObjectPtr<UScriptStruct>> GetDisallowedItemAssetFragments() const;
