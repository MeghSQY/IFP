 ...
 *
 * Docs:
 * https://varian.gitbook.io/varian-docs/inventoryframework/inventory-framework/classes-and-settings/a_itemactor/ */
...
public:	
	...
	UPROPERTY(BlueprintReadWrite, Category = "Inventory", ReplicatedUsing = "OnRep_RootItemID")
	FS_UniqueID RootItemID;
	UFUNCTION()
	void OnRep_RootItemID();
	UFUNCTION(BlueprintImplementableEvent, Category = "Inventory")
	void OnRepRootItemIDChanged();
	...
	UPROPERTY(BlueprintReadOnly, Category = "Settings", meta = (ExposeOnSpawn = true))
	TObjectPtr<UItemInstance> ItemInstanceTemplate = nullptr;
	...
	/**This actor has just spawned from being dropped out
	 * of another actors inventory.
	 * This is different from @BeginPlay, which always triggers
	 * when an actor like this spawns in any manner. */
	UFUNCTION(Category = "Inventory", BlueprintCallable, BlueprintNativeEvent)
	void SpawnedFromDropEvent(UAC_Inventory* PreviousOwner);

	UFUNCTION()
	void OnInventoryStartedPostDrop();
